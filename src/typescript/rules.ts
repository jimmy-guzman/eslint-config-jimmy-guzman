...
/**
 * https://github.com/typescript-eslint/typescript-eslint/tree/v5.14.0/packages/eslint-plugin/docs/rules
 */
export const rules: EslintRules = {
  ...
  /**
   * [@typescript-eslint/consistent-type-exports](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/consistent-type-exports.md)
   * - TYPE: `🎨 stylistic`
   * - RATIONALE: N/A
   */
  ...
  /**
   * [@typescript-eslint/explicit-function-return-type](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/explicit-function-return-type.md)
  ...
  /**
   * [@typescript-eslint/explicit-module-boundary-types](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/explicit-module-boundary-types.md)
   * - TYPE: `♻️ best-practice`
  ...
  /**
   * [@typescript-eslint/naming-convention](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/naming-convention.md)
   * - TYPE: `🎨 stylistic`
  ...
  /**
   * [@typescript-eslint/no-confusing-void-expression](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-confusing-void-expression.md)
   * - TYPE: `♻️ best-practice`
  ...
  /**
   * [@typescript-eslint/no-meaningless-void-operator](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-meaningless-void-operator.md)
  ...
  /**
   * [@typescript-eslint/no-non-null-asserted-nullish-coalescing](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-non-null-asserted-nullish-coalescing.md)
   * - TYPE: `♻️ best-practices`
  ...
  /**
   * [@typescript-eslint/no-redundant-type-constituents](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-redundant-type-constituents.md)
   * - TYPE:  `🚨 error`
  ...
  /**
   * [@typescript-eslint/no-unsafe-argument](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-unsafe-argument.md)
   * - TYPE: `♻️ best-practices`
  ...
  /**
   * [@typescript-eslint/no-useless-empty-export](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/no-useless-empty-export.md)
   * - TYPE:  `♻️ best-practices`
  ...
  /**
   * [@typescript-eslint/non-nullable-type-assertion-style](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/non-nullable-type-assertion-style.md)
   * - TYPE: `🎨 stylistic`
   * - RATIONALE: Verbose type casts offer more information
   */
  '@typescript-eslint/non-nullable-type-assertion-style': 'off',
  /**
   * [@typescript-eslint/padding-line-between-statement](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/padding-line-between-statements.md)
   * - TYPE: `🎨 stylistic`
  ...
  /**
   * [@typescript-eslint/prefer-return-this-type](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/prefer-return-this-type.md)
   * - TYPE: N/A
   * - RATIONALE: N/A
   */
  ...
  /**
   * [@typescript-eslint/sort-type-union-intersection-members](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/sort-type-union-intersection-members.md)
   * - TYPE: `🎨 stylistic`
   * - RATIONALE: Sorting can help keep your codebase standardized, find repeated types and reduce diff churn
   */
  '@typescript-eslint/sort-type-union-intersection-members': 'error',
  /**
   * [@typescript-eslint/space-before-blocks](https://github.com/typescript-eslint/typescript-eslint/blob/v5.14.0/packages/eslint-plugin/docs/rules/space-before-blocks.md)
   * - TYPE:  `♻️ best-practices`
